...
function loadAngular() {
    let angular = [{
        ...
        tagName: 'script',
        src: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/main.2635b73374b0e81e.js',
        rel: 'module'
    }];
...
function loadGlobalAngularStyling() {
    let angular = [{
        tagName: 'link',
        href: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/styles.9ab6ec9b8609c409.css',
        rel: 'stylesheet'
    }];
...
(function () {
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        localStorage.setItem('version', 'v1.0.4');
    });
