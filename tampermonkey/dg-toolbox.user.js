...
function loadCustomStyling() {
    ...
    loadResource({
        tagName: 'script',
        src: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/tampermonkey/parts/dg-toolbox-replace-icons-with-images.6.js',
        rel: 'text/javascript'
    }).onload = function () {
...
function loadAngular() {
    let angular = [{
        ...
        tagName: 'script',
        src: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/main.640a96cc62560d1c.js',
        rel: 'module'
    }];
...
function loadGlobalAngularStyling() {
    let angular = [{
        tagName: 'link',
        href: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/styles.1fd01cc1179c6369.css',
        rel: 'stylesheet'
    }];
