...
function loadCustomStyling() {
    loadResource({
        tagName: 'script',
        src: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/tampermonkey/parts/dg-toolbox-custom-styling.54.js',
        rel: 'text/javascript'
    }).onload = function () {
        applyCustomStyling();
    }
...
function loadGlobalAngularStyling() {
    let angular = [{
        tagName: 'link',
        href: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/styles.c9c1e6ba2c813d48.css',
        rel: 'stylesheet'
    }];
...
(function () {
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        localStorage.setItem('version', 'v1.0.11');
    });
