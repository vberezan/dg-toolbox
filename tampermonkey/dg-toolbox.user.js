...
function applyCustomStyling() {
    document.querySelectorAll('#planetList > #planetList').forEach((planet) => {
        planet.querySelector('.planetImage img').setAttribute('width', 82);
        planet.querySelector('.planetImage img').setAttribute('height', 82);
...
function setUpNgZone() {
    ...
    style.href = 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/styles.1db8b19e92b72728.css';
