...
function loadAngular() {
    let angular = [{
        ...
        tagName: 'script',
        src: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/main.3de197346a582e51.js',
        rel: 'module'
    }];
...
function loadGlobalAngularStyling() {
    let angular = [{
        tagName: 'link',
        href: 'https://cdn.jsdelivr.net/gh/vberezan/dg-toolbox/angular/toolbox-app/dist/toolbox-app/styles.30a9caded3ef4024.css',
        rel: 'stylesheet'
    }];
