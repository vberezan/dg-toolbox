...
function applyCustomStyling() {
    ...
    if (windowURL[1] === 'rankings' && (windowURL.length >= 4 && windowURL[2]) === 'players') {
        ...
        let pages = document.querySelector('#ranking-navigation').querySelector('.opacDarkBackground').innerText.trim().split('Page')[1].split('of');
        document.querySelector('#ranking-navigation').querySelector('.opacDarkBackground').innerHTML = pages[0] + '/' + pages[1];
    }
}
